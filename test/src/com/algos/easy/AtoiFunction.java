...
public class AtoiFunction {
	...
	public int myAtoi(String input) {
        int sign = 1; // For '+' it will be 1 for '-' it will be -1
        int result = 0; //result = 10 * result + digit;
        int index = 0;// index will decide from where it will start.
        int n = input.length();
        
        // Discard all spaces from the beginning of the input string.
        
        //First find the start. Remove all the leading spaces.
